		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVTestSetupTestSetupAccess().getGroup(), "rule__VTestSetupTestSetup__Group__0");
					put(grammarAccess.getVTestSetupTestSetupAccess().getGroup_4(), "rule__VTestSetupTestSetup__Group_4__0");
					put(grammarAccess.getVTestSetupTestSetupAccess().getGroup_5(), "rule__VTestSetupTestSetup__Group_5__0");
					...
					put(grammarAccess.getVTestSetupScenarioSectionAccess().getGroup_4(), "rule__VTestSetupScenarioSection__Group_4__0");
					put(grammarAccess.getVTestSetupScenarioSectionAccess().getGroup_6(), "rule__VTestSetupScenarioSection__Group_6__0");
					...
					put(grammarAccess.getVSVSTestingSpecificationDesignAccess().getTestSetupAssignment_4(), "rule__VSVSTestingSpecificationDesign__TestSetupAssignment_4");
					...
					put(grammarAccess.getVTestSetupTestSetupAccess().getInterfacesAssignment_2(), "rule__VTestSetupTestSetup__InterfacesAssignment_2");
					put(grammarAccess.getVTestSetupTestSetupAccess().getConfigurationsAssignment_4_1(), "rule__VTestSetupTestSetup__ConfigurationsAssignment_4_1");
					put(grammarAccess.getVTestSetupTestSetupAccess().getActionsAssignment_5_1(), "rule__VTestSetupTestSetup__ActionsAssignment_5_1");
					put(grammarAccess.getVTestSetupTestSetupAccess().getScenariosAssignment_7(), "rule__VTestSetupTestSetup__ScenariosAssignment_7");
					...
					put(grammarAccess.getVTestSetupInterfaceAccess().getIdAssignment_4(), "rule__VTestSetupInterface__IdAssignment_4");
					put(grammarAccess.getVTestSetupInterfaceAccess().getTcHeaderAssignment_6(), "rule__VTestSetupInterface__TcHeaderAssignment_6");
					put(grammarAccess.getVTestSetupInterfaceAccess().getTmHeaderAssignment_8(), "rule__VTestSetupInterface__TmHeaderAssignment_8");
					put(grammarAccess.getVTestSetupInterfaceAccess().getDescriptionAssignment_10(), "rule__VTestSetupInterface__DescriptionAssignment_10");
					...
					put(grammarAccess.getVTestSetupScenarioSectionAccess().getSupportedInterfaceAssignment_4_2(), "rule__VTestSetupScenarioSection__SupportedInterfaceAssignment_4_2");
					put(grammarAccess.getVTestSetupScenarioSectionAccess().getSelectedConfigurationAssignment_5(), "rule__VTestSetupScenarioSection__SelectedConfigurationAssignment_5");
					put(grammarAccess.getVTestSetupScenarioSectionAccess().getSupportedActionAssignment_6_2(), "rule__VTestSetupScenarioSection__SupportedActionAssignment_6_2");
					put(grammarAccess.getVTestSetupScenarioSectionAccess().getBodyAssignment_7(), "rule__VTestSetupScenarioSection__BodyAssignment_7");

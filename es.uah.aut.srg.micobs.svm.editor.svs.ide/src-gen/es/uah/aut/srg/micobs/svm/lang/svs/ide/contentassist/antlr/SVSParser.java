		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVSVSTBCsTBDsAccess().getGroup(), "rule__VSVSTBCsTBDs__Group__0");
					...
					put(grammarAccess.getVSVSDocumentAccess().getTbcsTbdsSectionAssignment_13(), "rule__VSVSDocument__TbcsTbdsSectionAssignment_13");
					put(grammarAccess.getVSVSDocumentAccess().getIntroductionSectionAssignment_14(), "rule__VSVSDocument__IntroductionSectionAssignment_14");
					put(grammarAccess.getVSVSDocumentAccess().getApplicableDocumentsSectionAssignment_15(), "rule__VSVSDocument__ApplicableDocumentsSectionAssignment_15");
					put(grammarAccess.getVSVSDocumentAccess().getReferenceDocumentsSectionAssignment_16(), "rule__VSVSDocument__ReferenceDocumentsSectionAssignment_16");
					put(grammarAccess.getVSVSDocumentAccess().getTermsDefinitionsAbbreviationsSectionAssignment_17(), "rule__VSVSDocument__TermsDefinitionsAbbreviationsSectionAssignment_17");
					put(grammarAccess.getVSVSDocumentAccess().getSoftwareOverviewSectionAssignment_18(), "rule__VSVSDocument__SoftwareOverviewSectionAssignment_18");
					put(grammarAccess.getVSVSDocumentAccess().getTaskIdentificationSectionAssignment_19(), "rule__VSVSDocument__TaskIdentificationSectionAssignment_19");
					put(grammarAccess.getVSVSDocumentAccess().getTestingSpecificationDesignSectionAssignment_20(), "rule__VSVSDocument__TestingSpecificationDesignSectionAssignment_20");
					put(grammarAccess.getVSVSDocumentAccess().getTestCasesSectionAssignment_21(), "rule__VSVSDocument__TestCasesSectionAssignment_21");
					put(grammarAccess.getVSVSDocumentAccess().getTestProceduresSectionAssignment_22(), "rule__VSVSDocument__TestProceduresSectionAssignment_22");
					put(grammarAccess.getVSVSDocumentAccess().getAnalysisInspectionReviewSectionAssignment_23(), "rule__VSVSDocument__AnalysisInspectionReviewSectionAssignment_23");
					put(grammarAccess.getVSVSDocumentAccess().getTestPlatformRequirementsSectionAssignment_24(), "rule__VSVSDocument__TestPlatformRequirementsSectionAssignment_24");
					put(grammarAccess.getVSVSDocumentAccess().getAdditionalInformationSectionAssignment_25(), "rule__VSVSDocument__AdditionalInformationSectionAssignment_25");
					put(grammarAccess.getVSVSTBCsTBDsAccess().getTbcsAssignment_2(), "rule__VSVSTBCsTBDs__TbcsAssignment_2");
					put(grammarAccess.getVSVSTBCsTBDsAccess().getTbdsAssignment_3(), "rule__VSVSTBCsTBDs__TbdsAssignment_3");
					...
					put(grammarAccess.getVSVSTestingSpecificationDesignAccess().getTestSetupAssignment_2(), "rule__VSVSTestingSpecificationDesign__TestSetupAssignment_2");
					put(grammarAccess.getVSVSTestingSpecificationDesignAccess().getGeneralAssignment_5(), "rule__VSVSTestingSpecificationDesign__GeneralAssignment_5");
					put(grammarAccess.getVSVSTestingSpecificationDesignAccess().getTestDesignsAssignment_7(), "rule__VSVSTestingSpecificationDesign__TestDesignsAssignment_7");

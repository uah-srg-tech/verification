		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVSVSStepOutputsCheckmodeAccess().getAlternatives(), "rule__VSVSStepOutputsCheckmode__Alternatives");
					...
					put(grammarAccess.getVSVSStepOutputAccess().getGroup(), "rule__VSVSStepOutput__Group__0");
					...
					put(grammarAccess.getVSVSTestingSpecificationDesignAccess().getScenariosAssignment_8(), "rule__VSVSTestingSpecificationDesign__ScenariosAssignment_8");
					put(grammarAccess.getVSVSTestingSpecificationDesignAccess().getTestDesignsAssignment_10(), "rule__VSVSTestingSpecificationDesign__TestDesignsAssignment_10");
					...
					put(grammarAccess.getVSVSInterfaceAccess().getDescriptionAssignment_4(), "rule__VSVSInterface__DescriptionAssignment_4");
					...
					put(grammarAccess.getVSVSScenarioSectionAccess().getInterfaceAssignment_4_2(), "rule__VSVSScenarioSection__InterfaceAssignment_4_2");
					put(grammarAccess.getVSVSScenarioSectionAccess().getBodyAssignment_5(), "rule__VSVSScenarioSection__BodyAssignment_5");
					...
					put(grammarAccess.getVSVSStepInputAccess().getDelay_valueAssignment_6(), "rule__VSVSStepInput__Delay_valueAssignment_6");
					put(grammarAccess.getVSVSStepInputAccess().getDelay_unitAssignment_8(), "rule__VSVSStepInput__Delay_unitAssignment_8");
					...
					put(grammarAccess.getVSVSStepOutputAccess().getNameAssignment_2(), "rule__VSVSStepOutput__NameAssignment_2");
					put(grammarAccess.getVSVSStepOutputAccess().getInterfaceAssignment_4(), "rule__VSVSStepOutput__InterfaceAssignment_4");
				}
			};
		}

		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVTraceableParentDocumentAccess().getAlternatives_3(), "rule__VTraceableParentDocument__Alternatives_3");
					...
					put(grammarAccess.getVSRSTBCsTBDsAccess().getGroup(), "rule__VSRSTBCsTBDs__Group__0");
					...
					put(grammarAccess.getVTraceableParentDocumentAccess().getGroup_3_0(), "rule__VTraceableParentDocument__Group_3_0__0");
					put(grammarAccess.getVTraceableParentDocumentAccess().getGroup_3_0_1(), "rule__VTraceableParentDocument__Group_3_0_1__0");
					...
					put(grammarAccess.getVSRSDocumentAccess().getTbcsTbdsSectionAssignment_13(), "rule__VSRSDocument__TbcsTbdsSectionAssignment_13");
					put(grammarAccess.getVSRSDocumentAccess().getIntroductionSectionAssignment_14(), "rule__VSRSDocument__IntroductionSectionAssignment_14");
					put(grammarAccess.getVSRSDocumentAccess().getApplicableDocumentsSectionAssignment_15(), "rule__VSRSDocument__ApplicableDocumentsSectionAssignment_15");
					put(grammarAccess.getVSRSDocumentAccess().getReferenceDocumentsSectionAssignment_16(), "rule__VSRSDocument__ReferenceDocumentsSectionAssignment_16");
					put(grammarAccess.getVSRSDocumentAccess().getTermsDefinitionsAbbreviationsSectionAssignment_17(), "rule__VSRSDocument__TermsDefinitionsAbbreviationsSectionAssignment_17");
					put(grammarAccess.getVSRSDocumentAccess().getSoftwareOverviewSectionAssignment_18(), "rule__VSRSDocument__SoftwareOverviewSectionAssignment_18");
					put(grammarAccess.getVSRSDocumentAccess().getRequirementsSectionAssignment_19(), "rule__VSRSDocument__RequirementsSectionAssignment_19");
					...
					put(grammarAccess.getVSRSTBCsTBDsAccess().getTbcsAssignment_2(), "rule__VSRSTBCsTBDs__TbcsAssignment_2");
					put(grammarAccess.getVSRSTBCsTBDsAccess().getTbdsAssignment_3(), "rule__VSRSTBCsTBDs__TbdsAssignment_3");
					...
					put(grammarAccess.getVTraceableParentDocumentAccess().getNotApplicableItemAssignment_3_0_1_2(), "rule__VTraceableParentDocument__NotApplicableItemAssignment_3_0_1_2");

		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVTestSetupDocumentAccess().getGroup_17(), "rule__VTestSetupDocument__Group_17__0");
					...
					put(grammarAccess.getVTestSetupDocumentAccess().getApplicableDocumentsSectionAssignment_12(), "rule__VTestSetupDocument__ApplicableDocumentsSectionAssignment_12");
					put(grammarAccess.getVTestSetupDocumentAccess().getReferenceDocumentsSectionAssignment_13(), "rule__VTestSetupDocument__ReferenceDocumentsSectionAssignment_13");
					put(grammarAccess.getVTestSetupDocumentAccess().getInterfacesAssignment_15(), "rule__VTestSetupDocument__InterfacesAssignment_15");
					put(grammarAccess.getVTestSetupDocumentAccess().getConfigurationsAssignment_17_1(), "rule__VTestSetupDocument__ConfigurationsAssignment_17_1");
					put(grammarAccess.getVTestSetupDocumentAccess().getActionsAssignment_18_1(), "rule__VTestSetupDocument__ActionsAssignment_18_1");
					put(grammarAccess.getVTestSetupDocumentAccess().getScenariosAssignment_20(), "rule__VTestSetupDocument__ScenariosAssignment_20");

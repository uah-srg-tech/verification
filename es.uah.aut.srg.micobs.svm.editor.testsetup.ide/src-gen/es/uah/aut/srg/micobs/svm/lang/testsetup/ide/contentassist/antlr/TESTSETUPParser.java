		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVTestSetupDocumentAccess().getGroup_20(), "rule__VTestSetupDocument__Group_20__0");
					...
					put(grammarAccess.getVTestSetupActionsOverVariablesSectionAccess().getGroup(), "rule__VTestSetupActionsOverVariablesSection__Group__0");
					put(grammarAccess.getVTestSetupActionOverVariableAccess().getGroup(), "rule__VTestSetupActionOverVariable__Group__0");
					...
					put(grammarAccess.getVTestSetupSupportedActionOverVariableAccess().getGroup(), "rule__VTestSetupSupportedActionOverVariable__Group__0");
					...
					put(grammarAccess.getVTestSetupDocumentAccess().getActionsOverVariablesAssignment_20_1(), "rule__VTestSetupDocument__ActionsOverVariablesAssignment_20_1");
					put(grammarAccess.getVTestSetupDocumentAccess().getScenariosAssignment_22(), "rule__VTestSetupDocument__ScenariosAssignment_22");
					...
					put(grammarAccess.getVTestSetupScenarioSectionAccess().getSupportedActionOverVariableAssignment_9(), "rule__VTestSetupScenarioSection__SupportedActionOverVariableAssignment_9");
					put(grammarAccess.getVTestSetupScenarioSectionAccess().getBodyAssignment_10(), "rule__VTestSetupScenarioSection__BodyAssignment_10");

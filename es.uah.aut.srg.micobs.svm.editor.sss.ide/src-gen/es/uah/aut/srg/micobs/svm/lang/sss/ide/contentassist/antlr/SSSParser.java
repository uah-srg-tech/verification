		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDFigureAccess().getNameAssignment_2(), "rule__DFigure__NameAssignment_2");
					put(grammarAccess.getDFigureAccess().getReferenceAssignment_4(), "rule__DFigure__ReferenceAssignment_4");
					put(grammarAccess.getDFigureAccess().getCaptionAssignment_6(), "rule__DFigure__CaptionAssignment_6");
					put(grammarAccess.getDPictureAsTableAccess().getNameAssignment_2(), "rule__DPictureAsTable__NameAssignment_2");
					put(grammarAccess.getDPictureAsTableAccess().getReferenceAssignment_4(), "rule__DPictureAsTable__ReferenceAssignment_4");
					put(grammarAccess.getDPictureAsTableAccess().getCaptionAssignment_6(), "rule__DPictureAsTable__CaptionAssignment_6");
					put(grammarAccess.getDBasicTableAccess().getNameAssignment_2(), "rule__DBasicTable__NameAssignment_2");
					put(grammarAccess.getDBasicTableAccess().getCaptionAssignment_4(), "rule__DBasicTable__CaptionAssignment_4");
					put(grammarAccess.getDBasicTableAccess().getRowsAssignment_6(), "rule__DBasicTable__RowsAssignment_6");
					...
					put(grammarAccess.getDApplicableDocumentAccess().getIssueAssignment_6(), "rule__DApplicableDocument__IssueAssignment_6");
					put(grammarAccess.getDApplicableDocumentAccess().getRevisionAssignment_8(), "rule__DApplicableDocument__RevisionAssignment_8");
					...
					put(grammarAccess.getDReferenceDocumentAccess().getIssueAssignment_6(), "rule__DReferenceDocument__IssueAssignment_6");
					put(grammarAccess.getDReferenceDocumentAccess().getRevisionAssignment_8(), "rule__DReferenceDocument__RevisionAssignment_8");

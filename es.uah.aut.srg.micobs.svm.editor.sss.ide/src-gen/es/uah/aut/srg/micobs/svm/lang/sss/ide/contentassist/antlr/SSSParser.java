		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDFigureFromFileAccess().getCaptionAssignment_10_1(), "rule__DFigureFromFile__CaptionAssignment_10_1");
					...
					put(grammarAccess.getDTableFromFileAccess().getCaptionAssignment_10_1(), "rule__DTableFromFile__CaptionAssignment_10_1");
					...
					put(grammarAccess.getDBasicTableAccess().getCaptionAssignment_5_1(), "rule__DBasicTable__CaptionAssignment_5_1");
					put(grammarAccess.getDBasicTableAccess().getRowsAssignment_7(), "rule__DBasicTable__RowsAssignment_7");

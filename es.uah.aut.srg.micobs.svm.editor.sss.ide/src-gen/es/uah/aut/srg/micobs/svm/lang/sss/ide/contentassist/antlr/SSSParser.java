		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVSSTBCsTBDsAccess().getGroup(), "rule__VSSTBCsTBDs__Group__0");
					...
					put(grammarAccess.getVSSSDocumentAccess().getTbcsTbdsSectionAssignment_12(), "rule__VSSSDocument__TbcsTbdsSectionAssignment_12");
					...
					put(grammarAccess.getVSSSDocumentAccess().getApplicableDocumentsSectionAssignment_14(), "rule__VSSSDocument__ApplicableDocumentsSectionAssignment_14");
					put(grammarAccess.getVSSSDocumentAccess().getReferenceDocumentsSectionAssignment_15(), "rule__VSSSDocument__ReferenceDocumentsSectionAssignment_15");
					put(grammarAccess.getVSSSDocumentAccess().getTermsDefinitionsAbbreviationsSectionAssignment_16(), "rule__VSSSDocument__TermsDefinitionsAbbreviationsSectionAssignment_16");
					put(grammarAccess.getVSSSDocumentAccess().getGeneralDescriptionSectionAssignment_17(), "rule__VSSSDocument__GeneralDescriptionSectionAssignment_17");
					put(grammarAccess.getVSSSDocumentAccess().getSpecificRequirementsSectionAssignment_18(), "rule__VSSSDocument__SpecificRequirementsSectionAssignment_18");
					put(grammarAccess.getVSSSDocumentAccess().getVerificationValidationIntegrationSectionAssignment_19(), "rule__VSSSDocument__VerificationValidationIntegrationSectionAssignment_19");
					put(grammarAccess.getVSSSDocumentAccess().getSystemModelsSectionAssignment_20(), "rule__VSSSDocument__SystemModelsSectionAssignment_20");
					put(grammarAccess.getVSSTBCsTBDsAccess().getTbcsAssignment_2(), "rule__VSSTBCsTBDs__TbcsAssignment_2");
					put(grammarAccess.getVSSTBCsTBDsAccess().getTbdsAssignment_3(), "rule__VSSTBCsTBDs__TbdsAssignment_3");

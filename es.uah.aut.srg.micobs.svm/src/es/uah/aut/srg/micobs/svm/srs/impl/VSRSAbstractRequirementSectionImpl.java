...
public abstract class VSRSAbstractRequirementSectionImpl extends VTraceableDocumentFixedGroupImpl implements VSRSAbstractRequirementSection {
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == DAbstractSection.class) {
			switch (derivedFeatureID) {
				case srsPackage.VSRS_ABSTRACT_REQUIREMENT_SECTION__SUBSECTIONS: return doctplPackage.DABSTRACT_SECTION__SUBSECTIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == DAbstractSection.class) {
			switch (baseFeatureID) {
				case doctplPackage.DABSTRACT_SECTION__SUBSECTIONS: return srsPackage.VSRS_ABSTRACT_REQUIREMENT_SECTION__SUBSECTIONS;
				default: return -1;
			}
		}
		if (baseClass == DFixedSection.class) {
	...
	public EList<DAbstractSection> getSubsections() {
		...
		for(DAbstractSection subsection : getSrsRequirementSubsections()) {
	...
	public EList<VTraceableDocumentAbstractItem> getItems() {
		...
		for(VTraceableDocumentAbstractGroup subsection : getSrsRequirementSubsections()) {
	...
	public EList<DReferenceableObject> getReferenceableObjects(String ReferenceableObjectType) {
		...
		for(DAbstractSection subsection : getSubsections()) {
			VSRSInstantiableRequirementSection instReqSection = (VSRSInstantiableRequirementSection)subsection;
			EList<DReferenceableObject> subObjects = instReqSection.getReferenceableObjects(ReferenceableObjectType);

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>VSVS Step Output Level2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.svm.svs.impl.VSVSStepOutputLevel2Impl#getLevel2 <em>Level2</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.svm.svs.impl.VSVSStepOutputLevel2Impl#getLevel2_filter <em>Level2 filter</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.svm.svs.impl.VSVSStepOutputLevel2Impl#getLevel1 <em>Level1</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.svm.svs.impl.VSVSStepOutputLevel2Impl#getLevel2_from_level1 <em>Level2 from level1</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.svm.svs.impl.VSVSStepOutputLevel2Impl#getLevel1_filter <em>Level1 filter</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.svm.svs.impl.VSVSStepOutputLevel2Impl#getLevel0 <em>Level0</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.svm.svs.impl.VSVSStepOutputLevel2Impl#getLevel1_from_level0 <em>Level1 from level0</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.svm.svs.impl.VSVSStepOutputLevel2Impl#getLevel0_filter <em>Level0 filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VSVSStepOutputLevel2Impl extends VSVSStepOutputImpl implements VSVSStepOutputLevel2 {
	/**
	 ...
	 * @generated
	 */
	protected VSVSStepOutputLevel2Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return svsPackage.Literals.VSVS_STEP_OUTPUT_LEVEL2;
	}
		...
		if (level2 != null && level2.eIsProxy()) {
			...
			if (level2 != oldLevel2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL2, oldLevel2, level2));
			}
		}
		return level2;
	}
	...
	public void setLevel2(TMTCIFFormatFormat newLevel2) {
		...
		level2 = newLevel2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL2, oldLevel2, level2));
	}
	...
	public NotificationChain basicSetLevel2_filter(VSVSStepFilter newLevel2_filter, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL2_FILTER, oldLevel2_filter, newLevel2_filter);
	...
	public void setLevel2_filter(VSVSStepFilter newLevel2_filter) {
		if (newLevel2_filter != level2_filter) {
			...
			if (level2_filter != null)
				msgs = ((InternalEObject)level2_filter).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL2_FILTER, null, msgs);
			if (newLevel2_filter != null)
				msgs = ((InternalEObject)newLevel2_filter).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL2_FILTER, null, msgs);
			msgs = basicSetLevel2_filter(newLevel2_filter, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL2_FILTER, newLevel2_filter, newLevel2_filter));
	}
	...
	public TMTCIFFormatFormat getLevel1() {
		if (level1 != null && level1.eIsProxy()) {
			...
			if (level1 != oldLevel1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL1, oldLevel1, level1));
			}
		}
		return level1;
	}
	...
	public void setLevel1(TMTCIFFormatFormat newLevel1) {
		...
		level1 = newLevel1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL1, oldLevel1, level1));
	}
	...
	public TMTCIFImportImport getLevel2_from_level1() {
		if (level2_from_level1 != null && level2_from_level1.eIsProxy()) {
			...
			if (level2_from_level1 != oldLevel2_from_level1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL2_FROM_LEVEL1, oldLevel2_from_level1, level2_from_level1));
			}
		}
	...
	public void setLevel2_from_level1(TMTCIFImportImport newLevel2_from_level1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL2_FROM_LEVEL1, oldLevel2_from_level1, level2_from_level1));
	}
	...
	public NotificationChain basicSetLevel1_filter(VSVSStepFilter newLevel1_filter, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL1_FILTER, oldLevel1_filter, newLevel1_filter);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLevel1_filter(VSVSStepFilter newLevel1_filter) {
		if (newLevel1_filter != level1_filter) {
			...
			if (level1_filter != null)
				msgs = ((InternalEObject)level1_filter).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL1_FILTER, null, msgs);
			if (newLevel1_filter != null)
				msgs = ((InternalEObject)newLevel1_filter).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL1_FILTER, null, msgs);
			msgs = basicSetLevel1_filter(newLevel1_filter, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL1_FILTER, newLevel1_filter, newLevel1_filter));
	}
	...
	public TMTCIFFormatFormat getLevel0() {
		if (level0 != null && level0.eIsProxy()) {
			...
			if (level0 != oldLevel0) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL0, oldLevel0, level0));
			}
		}
		return level0;
	}
	...
	public void setLevel0(TMTCIFFormatFormat newLevel0) {
		...
		level0 = newLevel0;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL0, oldLevel0, level0));
	}
	...
	public TMTCIFImportImport getLevel1_from_level0() {
		if (level1_from_level0 != null && level1_from_level0.eIsProxy()) {
			...
			if (level1_from_level0 != oldLevel1_from_level0) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL1_FROM_LEVEL0, oldLevel1_from_level0, level1_from_level0));
			}
		}
	...
	public void setLevel1_from_level0(TMTCIFImportImport newLevel1_from_level0) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL1_FROM_LEVEL0, oldLevel1_from_level0, level1_from_level0));
	}
	...
	public NotificationChain basicSetLevel0_filter(VSVSStepFilter newLevel0_filter, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL0_FILTER, oldLevel0_filter, newLevel0_filter);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLevel0_filter(VSVSStepFilter newLevel0_filter) {
		if (newLevel0_filter != level0_filter) {
			...
			if (level0_filter != null)
				msgs = ((InternalEObject)level0_filter).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL0_FILTER, null, msgs);
			if (newLevel0_filter != null)
				msgs = ((InternalEObject)newLevel0_filter).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL0_FILTER, null, msgs);
			msgs = basicSetLevel0_filter(newLevel0_filter, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL0_FILTER, newLevel0_filter, newLevel0_filter));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL2_FILTER:
				return basicSetLevel2_filter(null, msgs);
			case svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL1_FILTER:
				return basicSetLevel1_filter(null, msgs);
			case svsPackage.VSVS_STEP_OUTPUT_LEVEL2__LEVEL0_FILTER:

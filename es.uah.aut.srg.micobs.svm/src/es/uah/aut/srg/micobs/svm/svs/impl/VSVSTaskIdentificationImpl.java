...
public class VSVSTaskIdentificationImpl extends DFixedSectionImpl implements VSVSTaskIdentification {
	...
	public EList<DAbstractSection> getSubsections() {
		...
		subsections.add((DAbstractSection) getTaskCriteria());
		subsections.add((DAbstractSection) getFeaturesToBeTested());
		subsections.add((DAbstractSection) getFeaturesNotToBeTested());
		subsections.add((DAbstractSection) getTestPassFailCriteria());
		subsections.add((DAbstractSection) getItemsCanNotBeValidated());
		subsections.add((DAbstractSection) getManuallyAutoGeneratedCode());
		return subsections;
	}

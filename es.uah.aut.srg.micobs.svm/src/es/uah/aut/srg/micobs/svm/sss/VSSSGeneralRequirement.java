...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>VSSS General Requirement</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.svm.sss.VSSSGeneralRequirement#getSssItems <em>Sss Items</em>}</li>
 * </ul>
 *
 * @see es.uah.aut.srg.micobs.svm.sss.sssPackage#getVSSSGeneralRequirement()
 * @model
 * @generated
 */
public interface VSSSGeneralRequirement extends VTraceableDocumentFixedGroup, DFixedSection {
	/**
	 ...
	 * @see es.uah.aut.srg.micobs.svm.sss.sssPackage#getVSSSGeneralRequirement_SssItems()

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>VSVRTB Cs TB Ds</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.svm.svr.impl.VSVRTBCsTBDsImpl#getTbcs <em>Tbcs</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.svm.svr.impl.VSVRTBCsTBDsImpl#getTbds <em>Tbds</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VSVRTBCsTBDsImpl extends DFixedSectionImpl implements VSVRTBCsTBDs {
	/**
	...
	protected EClass eStaticClass() {
		return svrPackage.Literals.VSVRTB_CS_TB_DS;
	}
	...
	public EList<DTBC> getTbcs() {
		if (tbcs == null) {
			tbcs = new EObjectContainmentEList<DTBC>(DTBC.class, this, svrPackage.VSVRTB_CS_TB_DS__TBCS);
		}
		return tbcs;
	}
	...
	public EList<DTBD> getTbds() {
		if (tbds == null) {
			tbds = new EObjectContainmentEList<DTBD>(DTBD.class, this, svrPackage.VSVRTB_CS_TB_DS__TBDS);
		}
		return tbds;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case svrPackage.VSVRTB_CS_TB_DS__TBCS:
				return ((InternalEList<?>)getTbcs()).basicRemove(otherEnd, msgs);
			case svrPackage.VSVRTB_CS_TB_DS__TBDS:

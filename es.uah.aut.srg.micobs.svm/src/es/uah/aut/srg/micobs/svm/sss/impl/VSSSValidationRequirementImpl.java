...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>VSSS Validation Requirement</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.svm.sss.impl.VSSSValidationRequirementImpl#getSubsections <em>Subsections</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.svm.sss.impl.VSSSValidationRequirementImpl#getDocument <em>Document</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.svm.sss.impl.VSSSValidationRequirementImpl#getSssItems <em>Sss Items</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VSSSValidationRequirementImpl extends VTraceableDocumentFixedGroupImpl implements VSSSValidationRequirement {
	/**
	 ...
	 * @generated
	 */
	protected VSSSValidationRequirementImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return sssPackage.Literals.VSSS_VALIDATION_REQUIREMENT;
	}
	...
	public EList<VSSSDocumentItem> getSssItems() {
		if (sssItems == null) {
			sssItems = new EObjectContainmentEList<VSSSDocumentItem>(VSSSDocumentItem.class, this, sssPackage.VSSS_VALIDATION_REQUIREMENT__SSS_ITEMS);
		}
		return sssItems;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case sssPackage.VSSS_VALIDATION_REQUIREMENT__SSS_ITEMS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case sssPackage.VSSS_VALIDATION_REQUIREMENT__SUBSECTIONS:
				return getSubsections();
			case sssPackage.VSSS_VALIDATION_REQUIREMENT__DOCUMENT:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == DAbstractSection.class) {
			switch (derivedFeatureID) {
				case sssPackage.VSSS_VALIDATION_REQUIREMENT__SUBSECTIONS: return docPackage.DABSTRACT_SECTION__SUBSECTIONS;
				case sssPackage.VSSS_VALIDATION_REQUIREMENT__DOCUMENT: return docPackage.DABSTRACT_SECTION__DOCUMENT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == DAbstractSection.class) {
			switch (baseFeatureID) {
				case docPackage.DABSTRACT_SECTION__SUBSECTIONS: return sssPackage.VSSS_VALIDATION_REQUIREMENT__SUBSECTIONS;
				case docPackage.DABSTRACT_SECTION__DOCUMENT: return sssPackage.VSSS_VALIDATION_REQUIREMENT__DOCUMENT;
				default: return -1;
			}
		}
		if (baseClass == DFixedSection.class) {

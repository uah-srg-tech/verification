...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>VSSS Security Requirement</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.svm.sss.VSSSSecurityRequirement#getSssItems <em>Sss Items</em>}</li>
 * </ul>
 *
 * @see es.uah.aut.srg.micobs.svm.sss.sssPackage#getVSSSSecurityRequirement()
 * @model
 * @generated
 */
public interface VSSSSecurityRequirement extends VTraceableDocumentFixedGroup, DFixedSection {
	/**
	 ...
	 * @see es.uah.aut.srg.micobs.svm.sss.sssPackage#getVSSSSecurityRequirement_SssItems()

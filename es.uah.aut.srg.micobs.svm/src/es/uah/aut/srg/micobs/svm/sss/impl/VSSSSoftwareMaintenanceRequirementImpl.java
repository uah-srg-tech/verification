 ...
 *   <li>{@link es.uah.aut.srg.micobs.svm.sss.impl.VSSSSoftwareMaintenanceRequirementImpl#getDocument <em>Document</em>}</li>
...
public class VSSSSoftwareMaintenanceRequirementImpl extends VTraceableDocumentFixedGroupImpl implements VSSSSoftwareMaintenanceRequirement {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case sssPackage.VSSS_SOFTWARE_MAINTENANCE_REQUIREMENT__DOCUMENT:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == DAbstractSection.class) {
			switch (derivedFeatureID) {
				...
				case sssPackage.VSSS_SOFTWARE_MAINTENANCE_REQUIREMENT__DOCUMENT: return docPackage.DABSTRACT_SECTION__DOCUMENT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == DAbstractSection.class) {
			switch (baseFeatureID) {
				...
				case docPackage.DABSTRACT_SECTION__DOCUMENT: return sssPackage.VSSS_SOFTWARE_MAINTENANCE_REQUIREMENT__DOCUMENT;
				default: return -1;
			}
		}
		if (baseClass == DFixedSection.class) {

 ...
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.svm.svs.impl.VSVSProcedureStepsImpl#getName <em>Name</em>}</li>
...
public class VSVSProcedureStepsImpl extends MinimalEObjectImpl.Container implements VSVSProcedureSteps {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, svsPackage.VSVS_PROCEDURE_STEPS__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case svsPackage.VSVS_PROCEDURE_STEPS__NAME:
				return getName();
			case svsPackage.VSVS_PROCEDURE_STEPS__STEP:
				return getStep();
		}

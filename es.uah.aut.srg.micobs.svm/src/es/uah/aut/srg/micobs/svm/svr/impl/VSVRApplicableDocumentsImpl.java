...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>VSVR Applicable Documents</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.svm.svr.impl.VSVRApplicableDocumentsImpl#getApplicableDocuments <em>Applicable Documents</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VSVRApplicableDocumentsImpl extends DFixedSectionImpl implements VSVRApplicableDocuments {
	/**
	 ...
	 * @generated
	 */
	protected VSVRApplicableDocumentsImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return svrPackage.Literals.VSVR_APPLICABLE_DOCUMENTS;
	}
	...
	public EList<DApplicableDocument> getApplicableDocuments() {
		if (applicableDocuments == null) {
			applicableDocuments = new EObjectContainmentEList<DApplicableDocument>(DApplicableDocument.class, this, svrPackage.VSVR_APPLICABLE_DOCUMENTS__APPLICABLE_DOCUMENTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case svrPackage.VSVR_APPLICABLE_DOCUMENTS__APPLICABLE_DOCUMENTS:

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>VSVS Step Output Level0</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.svm.svs.impl.VSVSStepOutputLevel0Impl#getLevel0 <em>Level0</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.svm.svs.impl.VSVSStepOutputLevel0Impl#getLevel0_filter <em>Level0 filter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VSVSStepOutputLevel0Impl extends VSVSStepOutputImpl implements VSVSStepOutputLevel0 {
	/**
	 ...
	 * @generated
	 */
	protected VSVSStepOutputLevel0Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return svsPackage.Literals.VSVS_STEP_OUTPUT_LEVEL0;
	}
		...
		if (level0 != null && level0.eIsProxy()) {
			...
			if (level0 != oldLevel0) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, svsPackage.VSVS_STEP_OUTPUT_LEVEL0__LEVEL0, oldLevel0, level0));
			}
		}
		return level0;
	}
	...
	public void setLevel0(TMTCIFFormatFormat newLevel0) {
		...
		level0 = newLevel0;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, svsPackage.VSVS_STEP_OUTPUT_LEVEL0__LEVEL0, oldLevel0, level0));
	}
	...
	public NotificationChain basicSetLevel0_filter(VSVSStepFilter newLevel0_filter, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, svsPackage.VSVS_STEP_OUTPUT_LEVEL0__LEVEL0_FILTER, oldLevel0_filter, newLevel0_filter);
	...
	public void setLevel0_filter(VSVSStepFilter newLevel0_filter) {
		if (newLevel0_filter != level0_filter) {
			...
			if (level0_filter != null)
				msgs = ((InternalEObject)level0_filter).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - svsPackage.VSVS_STEP_OUTPUT_LEVEL0__LEVEL0_FILTER, null, msgs);
			if (newLevel0_filter != null)
				msgs = ((InternalEObject)newLevel0_filter).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - svsPackage.VSVS_STEP_OUTPUT_LEVEL0__LEVEL0_FILTER, null, msgs);
			msgs = basicSetLevel0_filter(newLevel0_filter, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, svsPackage.VSVS_STEP_OUTPUT_LEVEL0__LEVEL0_FILTER, newLevel0_filter, newLevel0_filter));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case svsPackage.VSVS_STEP_OUTPUT_LEVEL0__LEVEL0_FILTER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case svsPackage.VSVS_STEP_OUTPUT_LEVEL0__LEVEL0:

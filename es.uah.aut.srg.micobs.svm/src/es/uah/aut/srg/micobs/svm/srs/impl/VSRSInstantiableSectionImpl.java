...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>VSRS Instantiable Section</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class VSRSInstantiableSectionImpl extends DInstantiableSectionImpl implements VSRSInstantiableSection {
	 ...
	 * @generated
	 */
	protected VSRSInstantiableSectionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return srsPackage.Literals.VSRS_INSTANTIABLE_SECTION;
	}
	...
	public void setBody(DBody newBody) {
		if (newBody != body) {
			...
			if (body != null)
				msgs = ((InternalEObject)body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - srsPackage.VSRS_INSTANTIABLE_SECTION__BODY, null, msgs);
			if (newBody != null)
				msgs = ((InternalEObject)newBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - srsPackage.VSRS_INSTANTIABLE_SECTION__BODY, null, msgs);
			msgs = basicSetBody(newBody, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, srsPackage.VSRS_INSTANTIABLE_SECTION__BODY, newBody, newBody));
	}

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>VSSSTB Cs TB Ds</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.svm.sss.impl.VSSSTBCsTBDsImpl#getTbcs <em>Tbcs</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.svm.sss.impl.VSSSTBCsTBDsImpl#getTbds <em>Tbds</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VSSSTBCsTBDsImpl extends DFixedSectionImpl implements VSSSTBCsTBDs {
	/**
	...
	protected EClass eStaticClass() {
		return sssPackage.Literals.VSSSTB_CS_TB_DS;
	}
	...
	public EList<DTBC> getTbcs() {
		if (tbcs == null) {
			tbcs = new EObjectContainmentEList<DTBC>(DTBC.class, this, sssPackage.VSSSTB_CS_TB_DS__TBCS);
		}
		return tbcs;
	}
	...
	public EList<DTBD> getTbds() {
		if (tbds == null) {
			tbds = new EObjectContainmentEList<DTBD>(DTBD.class, this, sssPackage.VSSSTB_CS_TB_DS__TBDS);
		}
		return tbds;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case sssPackage.VSSSTB_CS_TB_DS__TBCS:
				return ((InternalEList<?>)getTbcs()).basicRemove(otherEnd, msgs);
			case sssPackage.VSSSTB_CS_TB_DS__TBDS:

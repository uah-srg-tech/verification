...
public abstract class AbstractSVSProposalProvider extends TerminalsProposalProvider {
	...
	public void completeVSVSProcedureSteps_PriorActionOverVariable(EObject model, Assignment assignment, ContentAssistContext context, ICompletionProposalAcceptor acceptor) {
		lookupCrossReference(((CrossReference)assignment.getTerminal()), context, acceptor);
	}
	...
	public void completeVSVSStepConfiguration_SelectedConfiguration(EObject model, Assignment assignment, ContentAssistContext context, ICompletionProposalAcceptor acceptor) {
		lookupCrossReference(((CrossReference)assignment.getTerminal()), context, acceptor);
	}
